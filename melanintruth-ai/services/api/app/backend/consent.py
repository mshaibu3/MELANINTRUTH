...
from .errors import AuthorizationError, ConsentRequiredError, NotFoundError
...
class ConsentService:
    ...
    def grant(
        self, user_id: str, purpose: ConsentPurpose, version: str = "2026-07"
    ) -> ConsentRecord:
        ...
        self.audit.record(
            ...
            user.id,
            user.tenant_id,
            {"purpose": purpose.value, "version": version},
        )
        return record
    ...
    def assert_granted(self, user_id: str, purpose: ConsentPurpose) -> None:
        ...
        for record in self.repo.consent.values():
            if (
                ...
                return
        raise ConsentRequiredError(f"valid {purpose.value} consent is required")
    ...
    def export_model_improvement_records(self, user_id: str) -> list[str]:
        ...
        return [
            ...
            if image.user_id == user_id and image.deleted_at is None
        ]
